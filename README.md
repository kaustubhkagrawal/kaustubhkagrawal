...
- [gowtham0992/link](https://github.com/gowtham0992/link) - Local personal memory for LLM agents (1 day ago)
- [Michaelliv/psst](https://github.com/Michaelliv/psst) - 🤫 AI-native secrets manager. Agents use secrets without seeing them. (6 days ago)
